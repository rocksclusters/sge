...
PrintConf()
{
   ...
   $ECHO "qlogin_command         /opt/gridengine/bin/rocks-qlogin.sh"
   $ECHO "rsh_command            /usr/bin/ssh"
   $ECHO "rlogin_command         /usr/bin/ssh"
   $ECHO "rsh_daemon             /usr/sbin/sshd -i -o Protocol=2"
   $ECHO "qlogin_daemon          /usr/sbin/sshd -i -o Protocol=2"
   $ECHO "rlogin_daemon          /usr/sbin/sshd -i -o Protocol=2"
